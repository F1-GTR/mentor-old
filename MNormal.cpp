...
TNormal *Normal;
//---------------------------------------------------------------------------
__fastcall TNormal::TNormal(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TNormal::Button1Click(TObject *Sender)
{
...
void __fastcall TNormal::Button3Click(TObject *Sender)
{
        Close();        
}
//---------------------------------------------------------------------------
...
void __fastcall TNormal::Button4Click(TObject *Sender)
{
...
void __fastcall TNormal::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TNormal::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TNormal::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TNormal::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TNormal::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
