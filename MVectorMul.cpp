...
#pragma resource "*.dfm"
TVectorMul *VectorMul;
//---------------------------------------------------------------------------
__fastcall TVectorMul::TVectorMul(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TVectorMul::Button1Click(TObject *Sender)
{
  ...
  quest->QuestType = ComboBox1->ItemIndex;
...
void __fastcall TVectorMul::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------
...
void __fastcall TVectorMul::Button4Click(TObject *Sender)
{
...
void __fastcall TVectorMul::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TVectorMul::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TVectorMul::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TVectorMul::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TVectorMul::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
