...
TLineCmp *LineCmp;
//---------------------------------------------------------------------------
__fastcall TLineCmp::TLineCmp(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TLineCmp::Button1Click(TObject *Sender)
{
  ...
  quest->TypeQ = ComboBox1->ItemIndex;
...
void __fastcall TLineCmp::Button3Click(TObject *Sender)
{
        Close();        
}
//---------------------------------------------------------------------------
...
void __fastcall TLineCmp::Button4Click(TObject *Sender)
{
...
void __fastcall TLineCmp::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TLineCmp::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TLineCmp::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TLineCmp::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TLineCmp::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
