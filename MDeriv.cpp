...
TFDeriv *FDeriv;
//---------------------------------------------------------------------------
__fastcall TFDeriv::TFDeriv (TComponent* Owner)
        : TForm(Owner)
{
}
void __fastcall TFDeriv::Button1Click (TObject *Sender)
{
    if (RadioButton2->Checked == true)
        quest->keygen = StrToInt(Edit3->Text);

    quest->derivid=StrToInt(etype->Text);
...
void __fastcall TFDeriv::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------

void __fastcall TFDeriv::Button4Click(TObject *Sender)
{
...
void __fastcall TFDeriv::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TFDeriv::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TFDeriv::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();
}
...
void __fastcall TFDeriv::FormShow(TObject *Sender)
{
    Memo1->Clear();
}
//---------------------------------------------------------------------------
