...
TLim01 *Lim01;
//---------------------------------------------------------------------------
__fastcall TLim01::TLim01(TComponent* Owner)
        : TForm(Owner)
{
}
void __fastcall TLim01::Button1Click (TObject *Sender)
{
    if (RadioButton2->Checked == true)
        quest->keygen = StrToInt(Edit3->Text);

    quest->typeoflim=StrToInt(etype->Text);
...
void __fastcall TLim01::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------

void __fastcall TLim01::Button4Click(TObject *Sender)
{
...
void __fastcall TLim01::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TLim01::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TLim01::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();
}
...
void __fastcall TLim01::FormShow(TObject *Sender)
{
    Memo1->Clear();
}
//---------------------------------------------------------------------------
