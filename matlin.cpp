...
Tpmatlin *pmatlin;
//---------------------------------------------------------------------------
__fastcall Tpmatlin::Tpmatlin(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall Tpmatlin::Button1Click(TObject *Sender)
{
  ModalResult = 1;
}
//---------------------------------------------------------------------------
void __fastcall Tpmatlin::Button2Click(TObject *Sender)
{
  String p = String("  ");
...
//---------------------------------------------------------------------------
void __fastcall Tpmatlin::RadioGroup1Click(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall Tpmatlin::FormActivate(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall Tpmatlin::Button3Click(TObject *Sender)
{
        if (RadioGroup1->ItemIndex == 0)
        {
...
void __fastcall Tpmatlin::Button4Click(TObject *Sender)
{
