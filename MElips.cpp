...
void __fastcall TElips::Button3Click(TObject *Sender)
{
        Close();        
}
//---------------------------------------------------------------------------
...
void __fastcall TElips::Button4Click(TObject *Sender)
{
...
void __fastcall TElips::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TElips::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TElips::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TElips::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TElips::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
