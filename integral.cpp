...
TOprInt *OprInt;
//---------------------------------------------------------------------------
__fastcall TOprInt::TOprInt(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TOprInt::Button1Click(TObject *Sender)
{
...
void __fastcall TOprInt::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------
...
void __fastcall TOprInt::Button4Click(TObject *Sender)
{
...
void __fastcall TOprInt::FormCreate(TObject *Sender)
{
        Memo1->Clear();
}
//---------------------------------------------------------------------------

void __fastcall TOprInt::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TOprInt::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TOprInt::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();
}
...
void __fastcall TOprInt::FormActivate(TObject *Sender)
{
        Memo1->Clear();
}
//---------------------------------------------------------------------------
