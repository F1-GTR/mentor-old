...
TKramer *Kramer;
//---------------------------------------------------------------------------
__fastcall TKramer::TKramer(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TKramer::Button1Click(TObject *Sender)
{
  ...
  s = Edit1->Text + p + Edit2->Text + p + StrToInt(ComboBox1->ItemIndex);
...
void __fastcall TKramer::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------
...
void __fastcall TKramer::Button4Click(TObject *Sender)
{
...
void __fastcall TKramer::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TKramer::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TKramer::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TKramer::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TKramer::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
