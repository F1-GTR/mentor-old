...
//---------------------------------------------------------------------------
__fastcall TIntegRnd::TIntegRnd(TComponent* Owner)
        : TForm(Owner)
{
}


void __fastcall TIntegRnd::Button1Click (TObject *Sender)
{
    if (RadioButton2->Checked == true)
        quest->keygen = StrToInt(Edit3->Text);

    quest->group=StrToInt(etype->Text);
...
void __fastcall TIntegRnd::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------

void __fastcall TIntegRnd::Button4Click(TObject *Sender)
{
...
void __fastcall TIntegRnd::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TIntegRnd::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TIntegRnd::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();
}
...
void __fastcall TIntegRnd::FormCreate(TObject *Sender)
{
    Memo1->Clear();
}
