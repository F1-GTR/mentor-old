...
TGiper *Giper;
//---------------------------------------------------------------------------
__fastcall TGiper::TGiper(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TGiper::Button1Click(TObject *Sender)
{
...
void __fastcall TGiper::Button3Click(TObject *Sender)
{
        Close();        
}
//---------------------------------------------------------------------------
...
void __fastcall TGiper::Button4Click(TObject *Sender)
{
...
void __fastcall TGiper::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TGiper::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TGiper::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TGiper::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TGiper::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
