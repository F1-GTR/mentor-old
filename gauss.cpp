...
#pragma resource "*.dfm"
TLinSistem *LinSistem;
//---------------------------------------------------------------------------
__fastcall TLinSistem::TLinSistem(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TLinSistem::Button1Click(TObject *Sender)
{
...
void __fastcall TLinSistem::Button3Click(TObject *Sender)
{
        Close();        
}
//---------------------------------------------------------------------------
...
void __fastcall TLinSistem::Button4Click(TObject *Sender)
{
...
void __fastcall TLinSistem::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TLinSistem::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TLinSistem::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TLinSistem::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();
}
...
void __fastcall TLinSistem::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
