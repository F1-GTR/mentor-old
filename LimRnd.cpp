...
TFLimRnd *FLimRnd;
//---------------------------------------------------------------------------
__fastcall TFLimRnd::TFLimRnd(TComponent* Owner)
        : TForm(Owner)
{
}
void __fastcall TFLimRnd::Button1Click (TObject *Sender)
{
    if (RadioButton2->Checked == true)
        quest->keygen = StrToInt(Edit3->Text);

    quest->groupoflims=StrToInt(etype->Text);
...
void __fastcall TFLimRnd::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------

void __fastcall TFLimRnd::Button4Click(TObject *Sender)
{
...
void __fastcall TFLimRnd::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TFLimRnd::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TFLimRnd::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();
}
...
void __fastcall TFLimRnd::FormShow(TObject *Sender)
{
    Memo1->Clear();
}
//---------------------------------------------------------------------------
