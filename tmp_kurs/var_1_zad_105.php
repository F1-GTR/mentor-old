...
location.href = "../mod_prov.php?id_user=" + f.id_user.value + "&id_kurs=" + f.id_kurs.value + "&ask_numb=" + f.ask.options[n].value + "&level=105"
}
</script>
</head>
<body>
...
<option value="5"> Вариант e) </option>
</select>
<p>
