...
TObrMatr *ObrMatr;
//---------------------------------------------------------------------------
__fastcall TObrMatr::TObrMatr(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TObrMatr::Button1Click(TObject *Sender)
{
...
void __fastcall TObrMatr::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------

void __fastcall TObrMatr::Button4Click(TObject *Sender)
{
...
void __fastcall TObrMatr::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TObrMatr::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TObrMatr::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TObrMatr::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();
}
...
void __fastcall TObrMatr::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
