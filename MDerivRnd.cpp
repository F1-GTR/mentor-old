...
TDerivRnd *DerivRnd;
//---------------------------------------------------------------------------
__fastcall TDerivRnd::TDerivRnd(TComponent* Owner)
        : TForm(Owner)
{
}
void __fastcall TDerivRnd::Button1Click (TObject *Sender)
{
    if (RadioButton2->Checked == true)
        quest->keygen = StrToInt(Edit3->Text);

    quest->groupofderivs=StrToInt(etype->Text);
...
void __fastcall TDerivRnd::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------

void __fastcall TDerivRnd::Button4Click(TObject *Sender)
{
...
void __fastcall TDerivRnd::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TDerivRnd::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TDerivRnd::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();
}
...
void __fastcall TDerivRnd::FormCreate(TObject *Sender)
{
    Memo1->Clear();
}
