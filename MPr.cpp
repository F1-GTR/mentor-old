...
TPr *Pr;
//---------------------------------------------------------------------------
__fastcall TPr::TPr(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TPr::Button1Click(TObject *Sender)
{
...
void __fastcall TPr::Button3Click(TObject *Sender)
{
        Close();        
}
//---------------------------------------------------------------------------
...
void __fastcall TPr::Button4Click(TObject *Sender)
{
...
void __fastcall TPr::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TPr::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TPr::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TPr::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
