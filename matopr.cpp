...
TMatdet *Matdet;
//---------------------------------------------------------------------------
__fastcall TMatdet::TMatdet(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TMatdet::Button1Click(TObject *Sender)
{
...
void __fastcall TMatdet::Button3Click(TObject *Sender)
{
        Close();        
}
//---------------------------------------------------------------------------
...
void __fastcall TMatdet::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TMatdet::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TMatdet::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TMatdet::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TMatdet::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
