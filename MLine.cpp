...
void __fastcall TLine::Button3Click(TObject *Sender)
{
        Close();        
}
//---------------------------------------------------------------------------
...
void __fastcall TLine::Button4Click(TObject *Sender)
{
...
void __fastcall TLine::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TLine::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TLine::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TLine::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TLine::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
