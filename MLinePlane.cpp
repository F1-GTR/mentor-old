...
#pragma resource "*.dfm"
TLinePlane *LinePlane;
//---------------------------------------------------------------------------
__fastcall TLinePlane::TLinePlane(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TLinePlane::Button1Click(TObject *Sender)
{
...
void __fastcall TLinePlane::Button3Click(TObject *Sender)
{
        Close();        
}
//---------------------------------------------------------------------------
...
void __fastcall TLinePlane::Button4Click(TObject *Sender)
{
...
void __fastcall TLinePlane::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TLinePlane::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TLinePlane::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TLinePlane::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TLinePlane::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
