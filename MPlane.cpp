...
TPlane *Plane;
//---------------------------------------------------------------------------
__fastcall TPlane::TPlane(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TPlane::Button1Click(TObject *Sender)
{
...
void __fastcall TPlane::Button3Click(TObject *Sender)
{
        Close();        
}
//---------------------------------------------------------------------------
...
void __fastcall TPlane::Button4Click(TObject *Sender)
{
...
void __fastcall TPlane::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TPlane::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TPlane::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TPlane::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TPlane::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
