...
TPRLine *PRLine;
//---------------------------------------------------------------------------
__fastcall TPRLine::TPRLine(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TPRLine::Button1Click(TObject *Sender)
{
...
void __fastcall TPRLine::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------
...
void __fastcall TPRLine::Button4Click(TObject *Sender)
{
...
void __fastcall TPRLine::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TPRLine::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TPRLine::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TPRLine::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();
}
...
void __fastcall TPRLine::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
