...
TRang *Rang;
//---------------------------------------------------------------------------
__fastcall TRang::TRang(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------

void __fastcall TRang::Button1Click(TObject *Sender)
{
...
void __fastcall TRang::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------

void __fastcall TRang::Button4Click(TObject *Sender)
{
        ...
        Preview->ImageEnIO1->LoadFromFileBMP( "out.bmp" );
...
void __fastcall TRang::FormCreate(TObject *Sender)
{
        Memo1->Clear();
}
//---------------------------------------------------------------------------

void __fastcall TRang::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TRang::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TRang::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();
}
...
void __fastcall TRang::FormActivate(TObject *Sender)
{
        Memo1->Clear();
}
//---------------------------------------------------------------------------
