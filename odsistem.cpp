...
#pragma resource "*.dfm"
TNullSystem *NullSystem;
//---------------------------------------------------------------------------
__fastcall TNullSystem::TNullSystem(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TNullSystem::Button1Click(TObject *Sender)
{
  ...
  quest->rang = StrToInt(Edit5->Text);
...
void __fastcall TNullSystem::Button3Click(TObject *Sender)
{
        Close();        
}
//---------------------------------------------------------------------------
...
void __fastcall TNullSystem::Button4Click(TObject *Sender)
{
...
void __fastcall TNullSystem::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TNullSystem::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TNullSystem::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TNullSystem::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TNullSystem::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
