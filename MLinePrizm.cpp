...
#pragma resource "*.dfm"
TLinePrizm *LinePrizm;
//---------------------------------------------------------------------------
__fastcall TLinePrizm::TLinePrizm(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TLinePrizm::Button1Click(TObject *Sender)
{
...
void __fastcall TLinePrizm::Button3Click(TObject *Sender)
{
        Close();        
}
//---------------------------------------------------------------------------
...
void __fastcall TLinePrizm::Button4Click(TObject *Sender)
{
...
void __fastcall TLinePrizm::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TLinePrizm::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TLinePrizm::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TLinePrizm::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TLinePrizm::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
