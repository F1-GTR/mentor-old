...
#pragma resource "*.dfm"
TPlaneLine *PlaneLine;
//---------------------------------------------------------------------------
__fastcall TPlaneLine::TPlaneLine(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TPlaneLine::Button1Click(TObject *Sender)
{
...
void __fastcall TPlaneLine::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------
...
void __fastcall TPlaneLine::Button4Click(TObject *Sender)
{
...
void __fastcall TPlaneLine::FormCreate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------

void __fastcall TPlaneLine::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TPlaneLine::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TPlaneLine::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();        
}
...
void __fastcall TPlaneLine::FormActivate(TObject *Sender)
{
        Memo1->Clear();        
}
//---------------------------------------------------------------------------
