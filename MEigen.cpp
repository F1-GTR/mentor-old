...
TEigen *Eigen;
//---------------------------------------------------------------------------
__fastcall TEigen::TEigen(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TEigen::Button1Click (TObject *Sender)
{
    if (RadioButton2->Checked == true)
        quest->keygen = StrToInt(Edit3->Text);
    quest->size=StrToInt(Edit1->Text);
    quest->variouseigens=StrToInt(Edit2->Text);
    quest->nquest=1;
    quest->nzad=1;
    String p = String("  ");
...
void __fastcall TEigen::Button3Click(TObject *Sender)
{
        Close();
}
//---------------------------------------------------------------------------

void __fastcall TEigen::Button4Click(TObject *Sender)
{
...
void __fastcall TEigen::FormCreate(TObject *Sender)
{
        Memo1->Clear();
}
//---------------------------------------------------------------------------

void __fastcall TEigen::RadioButton1Click(TObject *Sender)
{
...
void __fastcall TEigen::RadioButton2Click(TObject *Sender)
{
        if (RadioButton2->Checked == True)
        {
                Edit3->Enabled = True;
...
void __fastcall TEigen::Button2Click(TObject *Sender)
{
        Button1->Click();
        Close();
}
...
void __fastcall TEigen::FormActivate(TObject *Sender)
{
        Memo1->Clear();
}
//---------------------------------------------------------------------------
